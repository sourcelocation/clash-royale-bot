...
inline constexpr double kTerminalReward = 2.0;
inline constexpr double kTowerDamageRewardMultiplier = 0.35;
inline constexpr double kTowerDamagePenaltyMultiplier = 1.25;
