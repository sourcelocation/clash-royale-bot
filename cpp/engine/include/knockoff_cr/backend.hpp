...
inline constexpr int kCheapCardMaxCost = 2;
inline constexpr double kCheapCyclePenalty = 0.003;
inline constexpr double kHogStopReward = 0.04;
inline constexpr double kBuildingBacklinePenaltyBase = 1.0;
inline constexpr int kBuildingBacklineMaxRow = 6;
inline constexpr double kSpellHitReward = 0.01;
inline constexpr double kSpellMissPenalty = 0.015;
inline constexpr int kSpellHitRewardMaxTargets = 4;
